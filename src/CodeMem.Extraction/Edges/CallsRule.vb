...
' Description: The calls verb: invocation, object creation and member access to the bound member; implicit constructors redirect to the type (FR-017, spec Q4).
...
''' <summary>
''' Unresolved or candidate-ambiguous bindings, locals, parameters, type parameters, types and namespaces are never targets.
''' </summary>
